...
abstract contract StoryHuntRole is Ownable, Pausable {
  ...
  modifier onlyOperator() {
    require(operators[msg.sender], 'StoryHuntRole: not operator');
    _;
  }
  ...
  modifier onlyGuardian() {
    require(guardians[msg.sender], 'StoryHuntRole: not guardian');
    _;
  }
